...
### Essential genes in Gene ontology terms
 - The [Gene ontology (GO)](https://en.wikipedia.org/wiki/Gene_ontology) terms are derived from biological process category.
 
 - The percentage of essential genes in the GO terms, which involve over 150 genes, were examined.
